...
public class SubClassificationController extends HttpServlet {
            SubClassification subclassificarion = new SubClassification();
    /**
...
//        processRequest(request, response);
         subclassificarion.setMid(Integer.parseInt(request.getParameter("mID")));
         subclassificarion.setName(request.getParameter("txtsubClassificationName"));
        try {
            SubClassificationDAO.addsubclassific(subclassificarion);
