 ...
 * @author Yasotha
 */
@WebServlet(name = "mainUpdatePageViewController", urlPatterns = {"/mainUpdatePageViewController"})
public class mainUpdatePageViewController extends HttpServlet {
 MainClassification mainClassification =new MainClassification();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet mainUpdatePageViewController</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet mainUpdatePageViewController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
