...
public class AddBookController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        addbook.setBookID(request.getParameter("bookID"));
        addbook.setTitle(request.getParameter("title"));
        addbook.setAuthor(request.getParameter("auth"));
        addbook.setSubClassiID(Integer.parseInt(request.getParameter("sID")));
        addbook.setYearOfPublishing(Integer.parseInt(request.getParameter("YofPublish")));
        addbook.setLastprintedyear(Integer.parseInt(request.getParameter("lastPrintYr")));
        addbook.setISBNno(request.getParameter("ISBNno"));
        addbook.setNoOfPages(Integer.parseInt(request.getParameter("NoOfPages")));
        try {
