...
public class editController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("mainclasi", books);
            ...
            subClassificatons = SubClassificationDAO.getSubClassific();
            request.setAttribute("subClassifications", subClassificatons);
            
            String bookId = request.getParameter("bookId");
            Book book = new Book();
            searchUpdateDao sud = new searchUpdateDao();
            book = sud.getBookById(bookId);
